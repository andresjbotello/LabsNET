...
namespace Negocio
{
    ...
    {
        private SqlDataAdapter daUsuarios;
        private SqlConnection conn;

        protected SqlDataAdapter DaUsuarios { get => daUsuarios; set => daUsuarios = value; }
        protected SqlConnection Conn { get => conn; set => conn = value; }
