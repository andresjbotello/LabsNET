...
namespace Ejercicio1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            rwAlumno2[colNombre] = "Victoria";
            rwAlumno2[colApellido] = "Masson";
            ...
            rwAlumnosCursos[col_ac_IDAlumno] = 0; //El primer alumno
            ...
            foreach (DataRow rowCu in row_CursoInf)
            {
                ...
                {
                    string v = rowAl.GetParentRow(relAlumno_ac)[colNombre].ToString();
                    Console.WriteLine(rowAl.GetParentRow(relAlumno_ac)[colApellido].ToString() + ", " + v);
                }
            }
            Console.ReadLine();
        }
